...
On my honor as a student, I did not recieve nor given any unauthorized aid on this assignment
Brian Soltani
...
public class Casino{
   public static void main(String[] args){
      ...
      while (player.getMoney() >= SlotMachine.getCost()){
         spins++;
         machine.pull();
         System.out.println(machine);
         Player.setMoney(player.getMoney() - SlotMachine.getCost());
         int winnings = SlotMachine.getMultiplier();
         if (winnings > 0){
